...
@section('content')
    ...
    <div class="container py-3 col-10">
        @if(isset($message))
            <div class="p-2">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{url('product/create')}}" id="btn-add" class="btn btn-success actions" title="Novo registro">
            ...
            @if(isset($paginator) && count($paginator->items()))
                @foreach($paginator->items() as $item)
                    <tr class="text-center">
                        ...
                        <td>{{isset($item->category) ? $item->category->name : 'nao possui'}}</td>
                        ...
                        <td class="d-flex justify-content-end gap-3">
                            ...
                            <a   href="{{url('product')}}/{{$item->id}}/edit" class="btn-edit text-dark text-decoration-none">
